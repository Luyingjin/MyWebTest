...
using MvcApiSwaggerTest;
using Swashbuckle.Application;
using System.Linq;
using MvcApiSwaggerTest.App_Start;
using System.Reflection;
using MvcApiSwaggerTest.AuthAttributes;

[assembly: PreApplicationStartMethod(typeof(SwaggerConfig), "Register")]

namespace MvcApiSwaggerTest
{
    public class SwaggerConfig
    {
        public static void Register()
        {
            ...
            var xmlFile = string.Format("{0}/bin/MvcApiSwaggerTest.xml", System.AppDomain.CurrentDomain.BaseDirectory);
